...
from tkinter import ttk, messagebox, END, Toplevel, filedialog
...
notebook.add(frame_funcion, text="Archivo de texto")
...
tab_control_funcion = ttk.Notebook(frame_funcion)
tab_control_funcion.pack(expand=True, fill="both")

# Creo el frame  para el editor de texto
frame_editor_texto = ttk.Frame(tab_control_funcion)
tab_control_funcion.add(frame_editor_texto, text="Editor de texto")

# Área de texto en la pestaña del editor
text_area = tk.Text(frame_editor_texto, wrap="word", undo=True)
text_area.pack(expand=True, fill="both", padx=10, pady=10)

# Creó una función para abrir un archivo de texto
def abrir_archivo():
    ...
    if archivo_path:
        try:
            with open(archivo_path, "r") as archivo:
                ...
                text_area.insert(END, archivo.read()) 
        except Exception as e:
            messagebox.showerror("Error", f"No se pudo abrir el archivo: {e}") 

# Aquí creo una función para guardar un archivo de texto
def guardar_archivo():
...
# Mis botones para abrir y guardar archivos
frame_botones_editor = ttk.Frame(frame_editor_texto) 
frame_botones_editor.pack(fill="x", pady=10)

btn_abrir = ttk.Button(frame_botones_editor, text="Abrir archivo", command=abrir_archivo) 
btn_abrir.pack(side="left", padx=10)

btn_guardar = ttk.Button(frame_botones_editor, text="Guardar archivo", command=guardar_archivo) 
...
ruta_imagen = r"C:/Perifericos/ya_es_toda_wey.jpg" #Cambia esta ruta si es necesario
